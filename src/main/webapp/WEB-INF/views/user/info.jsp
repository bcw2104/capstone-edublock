...
<div class="px-4 pb-4">
	<div class="mypage-content">
		<div class="mb-4">
			<img class="profile-img mb-2" alt="profile" src="/resources/images/logo.png">
		...
		<div class="form-group">
			...
			<div class="input-group">
				<input type="text" class="form-control" value="${sessionScope.user.userNickname}">
				<button class="btn btn-primary input-group-append">변경</button>
			</div>
		</div>
		<div class="form-group">
