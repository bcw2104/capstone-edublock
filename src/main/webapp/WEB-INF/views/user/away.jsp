...
<div class="p-4">
	...
	<form id="awayForm" class="mypage-content">
		...
		<div class="form-group">
			...
			<input type="password" id="awayPw" name="userPw" class="form-control">
			<div class="form-msg"></div>
		</div>
		<div class="text-right">
			<button type="button" id="awayBtn" class="btn btn-primary">회원 탈퇴</button>
		</div>
	</form>
</div>